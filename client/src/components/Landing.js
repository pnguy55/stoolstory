...
class Landing extends Component {
    ...
    renderContent() {
        ...
        switch (this.props.auth){
            ...
            case false:
                return [
                    <li key='1' className='landing-pitch'><img src='./assets/landing-scroll.png'/></li>,
                    <li key='2' className='landing-pitch'><h2>Log your logs</h2></li>,
            ...
            default:
                return [
                    ...
                    <li key='1' className='logged-in-ll'><Link id='new-list' className='btn sidenav-close' to='/add_log'>Add Log</Link></li>,
