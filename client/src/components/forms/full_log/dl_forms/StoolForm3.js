...
import renderFieldStoolFormName from '../dl_renders/renderFieldsRadio';
...
let StoolForm2 = ({ 
        ...
        return(
            <div className='row'>
                ...
                <div className='soft-outter btn-wrapper col s12 m4 offset-m3 l3 offset-l2'>
                    <button type='button' style={{height:'2rem', display:'flex', alignItems:'center', justifyContent:'space-evenly'}} onClick={() => {console.log(listOfChosenTags);submitStoolForm(listOfChosenTags, formValues.title)}} className="soft-inner right black-text">
                        Save
    ...
    // const stoolFormer = (wholeListOfTags) => {
            ...
            <form className='row'>
                ...
                <div className='container'>
                    ...
                    <ul className='flex-column' style={{listStyleType:'none'}}>
                        <li key='1'><Link className='btn dash-btn' to='/stoolForms'>View My Saved Lists</Link></li>
                    </ul>
                </div>
            </form>
